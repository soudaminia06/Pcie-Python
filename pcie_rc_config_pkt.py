...
class pcie_seq_rc_config_pkt(pcie_pkg):
    ...
    def cfg0_pkt(self):
        ...
        self.ep                     = 0 
        self.td                     = 0
        self.tc                     = 0 #random.getrandbits(3) 
        self.attr0                  = 0 #random.getrandbits(2)
        self.attr1                  = 0 #random.getrandbits(1)
        self.at                     = 0 # random.getrandbits(2)
        self.length                 = 1 #random.getrandbits(10)
